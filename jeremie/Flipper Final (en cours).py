...
def arcG(A, B, C, body, space, largeur_trait):
    ...
    omega = alpha / coeff
    Cord1 = [C[0] + sin(omega / 2262) * R * (-1 if CA[0] < 0 else 1),
             C[1] + cos(omega / 2262) * R * (-1 if CA[1] < 0 else 1)]
...
def add_lines(space):
    ...
    rotation_center_body.position = (223, 12)

    body = pymunk.Body(10, 100000)
    body.position = (223, 12)
    largeur_trait = 1.0
    ...
    l7 = pymunk.Segment(body, (353.0, 390), (353.0, 67), largeur_trait)
    ...
    space.add(l1, l2, l3, l4, l5, l6, l7, l8, body, rotation_center_joint, rotation_center_joint2)
...
r_flipper_body.position = 508, 100
...
s = pymunk.DampedRotarySpring(r_flipper_body, r_flipper_joint_body, 0.25, 50000000, 2000000)
space.add(j, s)

# left flipper
l_flipper_body = pymunk.Body(mass, moment)
l_flipper_body.position = 295, 100
...
s = pymunk.DampedRotarySpring(l_flipper_body, l_flipper_joint_body, -0.25, 50000000, 2000000)
space.add(j, s)
